...
public class Solution {
    ...
    public static class IncomeDataAdapter implements Customer, Contact {
        ...
        public String getPhoneNumber() {
            ...
            if (number.length() < 10)
                number = String.format("%010d", data.getPhoneNumber());

            String number1 = number.substring(0, 3);
            String number2 = number.substring(3, 6);
            String number3 = number.substring(6, 8);
            String number4 = number.substring(8);

            return String.format("+%s(%s)%s-%s-%s", code, number1, number2, number3, number4);
        }
